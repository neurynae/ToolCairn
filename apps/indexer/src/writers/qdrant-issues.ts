...
import { ISSUES_COLLECTION_NAME, qdrantClient } from '@toolpilot/vector';
import { embedText } from '@toolpilot/vector';
import pino from 'pino';
import type { GitHubIssue } from '../crawlers/github-issues.js';
import { IndexerError } from '../errors.js';

const logger = pino({ name: '@toolpilot/indexer:qdrant-issues-writer' });
