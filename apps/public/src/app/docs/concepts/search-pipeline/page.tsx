    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <section className="mt-4">
          ...
          >
            Every <code style={{ color: 'var(--tp-accent)' }}>search_tools</code> call flows
        ...
        <section>
          ...
          >
            ...
            by <code style={{ color: 'var(--tp-accent)' }}>maintenance_score</code>, ensuring a
        ...
        <section>
          ...
          >
            <li>
              ...
              <code style={{ color: 'var(--tp-accent)' }}>RELATED_TO</code> edges to other
          ...
          >
            <p className="text-sm font-mono" style={{ color: 'var(--tp-text-primary)' }}>
